...
export function useSiteEffects() {
    useEffect(() => {
        ...
        // 1. Smooth Scroll using delegation
        ...
        if (nav) cleanupFns.push(() => nav.removeEventListener("click", navClickHandler));
        ...
        // 5. Section Fade-in using reusable observer
        ...
        if (imageWrapper) {
            const handleMouseMove = (e) => {
                ...
                imageWrapper.style.transform = `rotateX(${rotateX}deg) rotateY(${rotateY}deg) scale(1.05)`;
    ...
    `;
            ...
            const handleMouseLeave = () => {
                imageWrapper.style.transition = "transform 0.5s ease, box-shadow 0.5s ease";
                imageWrapper.style.transform = "rotateX(0deg) rotateY(0deg) scale(1)";
                imageWrapper.style.boxShadow = "0 15px 30px rgba(130, 69, 236, 0.5)";
            };
    ...
    `;
        ...
        // 10. Back to Top Scroll Show/Hide
